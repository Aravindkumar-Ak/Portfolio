...
<div className="flex items-center w-full h-full bg-cover bg-center " style={{ backgroundImage:"url(/bg.jpg)" }} >
 <div className="pl-[20px] md:pl-60 pb-56 md:pb-20 z-[10] max-w-[750px] flex-col gap-5  justify-center text-center">
...
<p className="text-gray-200 my-4 px-4 text-sm md:block md:px-2 md:text-lg">
Passionate software developer proficient in React.js, Node.js, and Java, with a strong enthusiasm for creating innovative and efficient solutions.
 Possesses a solid foundation in both front-end and back-end development, adapt at building dynamic web applications. 
          </p>
